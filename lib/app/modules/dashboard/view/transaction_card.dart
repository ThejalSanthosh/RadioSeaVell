...
final cashController =
    TextEditingController(text: transaction.cashAmount.toString());

final upiController =
    TextEditingController(text: transaction.upiAmount.toString());
            ...
            child: SingleChildScrollView(
              child: Column(
                ...
                children: [
                  ...
                  // ),
                  // SizedBox(height: 16),
_buildTextField(cashController, 'Cash Amount', Icons.money),
SizedBox(height: 12),
_buildTextField(upiController, 'UPI Amount', Icons.qr_code),
                  SizedBox(height: 16),
...
final previousBalance = double.parse(previousCreditController.text);

// Outstanding after payment
final currentBalance =
    (totalAmount + previousBalance - paidAmount).clamp(0, double.infinity);
...
if (paidAmount > totalAmount + previousBalance) {
  throw Exception('Paid amount cannot exceed total payable');
}
